...
singularity instance start --nv --workdir ./tmp --bind $(pwd):$HOME --bind "$LDIR:$HOME/.local" instance austin_docker.sif instance1
singularity exec instance://instance1 'bash singularity_preamble_new.sh'
singularity exec instance://instance1 "python experiment_script.sh"
